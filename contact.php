<?php
$toEmail 		= "johnrim2@gmail.com"; //Replace it recipient email address
$subject 		= 'Message from portfolio'; //Subject line for emails
...
if(!$sentMail)
	{
		...
		echo '<h3>Hi '.$postName.', Thanks for reaching out!</h3>';
	}
